...
public class AccountApplication extends VertxApplication<MainVerticle> {

    protected final static Logger logger = LoggerFactory.getLogger(AccountApplication.class);

    private static final String NAME = "account-application";
    ...
    public void initialize(EnvironmentSetup setup) throws Exception {
        ...
        setup.configure(new AccountContextConfig());
    }
}
