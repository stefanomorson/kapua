...
public class AccountServiceModule implements ServiceModule {
    ...
    public void start() throws KapuaException {
        ...
        eventbus.subscribe(intrnalEventsAddressSubscribe, kapuaEventService);
        ...
        Runnable houseKeeperJob = new EventStoreHouseKeeperJob(eventbus, userEventsAddressPublish);
