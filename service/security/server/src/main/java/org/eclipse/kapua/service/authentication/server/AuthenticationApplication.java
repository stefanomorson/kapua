...
public class AuthenticationApplication extends VertxApplication<MainVerticle> {

    protected final static Logger logger = LoggerFactory.getLogger(AuthenticationApplication.class);

    private static final String NAME = "authentication-application";

    public static void main(String args[]) throws Exception {
        AuthenticationApplication application = null;
        try {
    ...
    public void initialize(EnvironmentSetup setup) throws Exception {
        ...
        setup.configure(new AuthenticationContextConfig());
    }
}
