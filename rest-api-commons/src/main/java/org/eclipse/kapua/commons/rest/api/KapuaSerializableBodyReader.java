...
public class KapuaSerializableBodyReader implements MessageBodyReader<KapuaSerializable> {
    ...
    @Override
    public KapuaSerializable readFrom(Class<KapuaSerializable> type, Type genericType, Annotation[] annotations, MediaType mediaType, 
