 ...
 *******************************************************************************/
package org.eclipse.kapua.account.service.api.rest;
...
import org.eclipse.kapua.commons.rest.api.BlockingCodeExecutor;
...
public class AccountsResource extends AbstractKapuaResource {
    ...
    public void simpleQuery( //
        ...
        new BlockingCodeExecutor(vertx, headers).exec(
                future -> {
                    try {
