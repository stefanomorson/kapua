...
@Api("Roles")
@Path("{scopeId}/roles")
public class RolesResource extends AbstractKapuaResource {
        ...
        new AuthenticatedSessionExecutor(vertx, headers).exec(
                future -> {
                    try {
                        ...
                        RoleListResult result = roleService.query(query);
        ...
        new AuthenticatedSessionExecutor(vertx, headers).exec(
                future -> {
                    try {
                        ...
                        CountResult result = new CountResult(roleService.count(query));
        ...
        new AuthenticatedSessionExecutor(vertx, headers).exec(
                future -> {
                    try {
                        ...
                        Role result = roleService.create(roleCreator);
