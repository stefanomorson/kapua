...
public class CredentialsResource extends AbstractKapuaResource {
        ...
        new AuthenticatedSessionExecutor(vertx, headers).exec(
                future -> {
                    try {
                        ...
                        CredentialListResult result = credentialService.query(query);
        ...
        new AuthenticatedSessionExecutor(vertx, headers).exec(
                future -> {
                    try {
                        ...
                        CountResult result = new CountResult(credentialService.count(query));
        ...
        new AuthenticatedSessionExecutor(vertx, headers).exec(
                future -> {
                    try {
                        ...
                        Credential result = credentialService.create(credentialCreator);
        ...
        new AuthenticatedSessionExecutor(vertx, headers).exec(
                future -> {
                    try {
                        ...
                        Credential result = credentialService.update(credential);
